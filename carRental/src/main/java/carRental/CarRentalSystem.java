...
public class CarRentalSystem {
        ...
        try (Connection conn = getConnection();
            ...
            try (ResultSet rs = pstmtGetBooking.executeQuery()) {
                if (rs.next()) {
                    ...
                    double rentalRatePerDay = 1500.0;
    ...
    public static void main(String[] args) {
        ...
        // Main menu
        while (true) {
            System.out.println("\n WELCOME, Start Your Car Rental Journey Here");
            System.out.println("1. New Customer? Register Here");
            System.out.println("2. Login");
            System.out.println("3. View Cars Ready for Rent");
            System.out.println("4. Rent your Desired Car");
            System.out.println("5. Return your rental car");
